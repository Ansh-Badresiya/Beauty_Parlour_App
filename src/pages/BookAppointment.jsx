        ...
        {submitted ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-400">or fill the form</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              >
                {isSubmitting ? (
                  <span className="flex items-center gap-2"><span className="w-5 h-5 border-2 border-white/40 border-t-white rounded-full animate-spin" />{t.submit}...</span>
                ) : (
                  <><Heart className="w-5 h-5" />{t.submit}</>
                )}
              </button>
            </form>
          </div>
